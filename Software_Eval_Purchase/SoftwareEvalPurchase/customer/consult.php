...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
          <div class="pull-right"><a href="consult-request.php"><button type="button" class="btn btn-default">Talk to an Expert</button></a></div>
      	  <h1>Consultations</h1>
          <p>View your active and past consultations below.  You can reschedule your active appointments, record notes or exchange files.</p>
          <br>
