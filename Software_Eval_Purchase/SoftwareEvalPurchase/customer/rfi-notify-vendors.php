...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
          ...
          <h1>Request for Information sent to Vendors</h1>

		  <p>We relayed your information request to the below vendors.  You will receive email notification when the vendors respond.</p>
		  <ul>
		  	<li>Tableau</li>
		  	<li>MicroStrategy</li>
		  	<li>QlikView</li>
